...
I demonstrated my skills in `MongoDB` with `Express.js`. The project is a simple REST API that allows you to create, read, update and delete objects from a MongoDB database.
